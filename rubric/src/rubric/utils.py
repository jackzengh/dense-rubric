...
### To replace these functions with your own, implement similar async functions that call your LLM client, handle retries and errors, and return validated output conforming to the expected schemas. ###
